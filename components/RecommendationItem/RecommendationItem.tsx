...
function RecommendationItem({ media_type, id, poster_path, backdrop_path, title, vote_average = 0, first_air_date, release_date }: MovieInfo) {
    ...
    return (
        <a href={`/${media_type ? media_type : 'tv'}/${id}`} className={styles.recommendItem}>
            <div className={styles.imageContainer}>
                ...
                <div className={clsx(styles.imageDate, isHover && styles.active)}><Icon className={styles.icon} component={DateRangeIcon} /> {first_air_date || release_date}</div>
            </div>
