...
function SocialLink() {
    ...
    return (
        <div className={styles.container}>
            ...
            {externalIds?.imdb_id && <a href={`https://www.wikidata.org/wiki/${externalIds.wikidata_id}`} target="_blank"><Tooltip title="Wikipedia" placement='top-start'><Icon className={styles.icon} component={ImportContactsIcon} /></Tooltip></a>}
        </div>
    );
}
